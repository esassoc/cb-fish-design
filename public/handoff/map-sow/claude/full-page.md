...
>
  <div id="sowbox">
    <div class="sowhead">
      Statement of Work — Habitat Program
      <button onclick="closeSOW()">✕</button>
    </div>
    <div id="sowbody"></div>
    <div class="sowfoot">
