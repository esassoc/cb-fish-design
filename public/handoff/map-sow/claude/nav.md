...
- **Section element:** `<nav>`
- **Components:** cbf-app-bar (spoke), cbf-icon (spoke), cbf-nav-collapsible (spoke), cbf-omni-trigger (spoke), esa-app-bar (hub), esa-button (hub), esa-icon (hub), esa-link-column (hub), esa-nav-dropdown (hub)
