...
|---|---|---|
| `cbf-app-bar` | spoke | — |
| `cbf-app-footer` | spoke | src/components/cbfish-home/cbf-app-footer.astro |
| `cbf-home` | spoke | — |
...
| `cbf-program-impacts` | spoke | src/components/cbfish-home/cbf-program-impacts.astro |
| `cbf-program-overview` | spoke | src/components/cbfish-home/cbf-program-overview.astro |
