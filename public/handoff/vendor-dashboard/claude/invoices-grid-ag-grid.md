...
<section class="cbf-vendor-dashboard-invoices stack" data-gap="md">
                  ...
                  >
                      ...
                      >
                        <span
                          ><span class="cbf-grid-status"
                            ><span class="esa-pill esa-pill--info esa-pill--md">
                    ...
                    >
                      ...
                      >
                        <span
                          ><span class="cbf-grid-status"
                            ><span class="esa-pill esa-pill--warning esa-pill--md">
                    ...
                    >
                      ...
                      >
                        <span
                          ><span class="cbf-grid-status"
                            ><span class="esa-pill esa-pill--success esa-pill--md">
                    ...
                    >
                      ...
                      >
                        <span
                          ><span class="cbf-grid-status"
                            ><span class="esa-pill esa-pill--danger esa-pill--md">
            ...
            <div class="cbf-invoice-card__title-row">
              ...
              <div class="cbf-invoice-card__corner">
                <span class="cbf-invoice-card__status"
                  ><span class="esa-pill esa-pill--info esa-pill--sm">
                    <span class="esa-pill__label">Draft</span>
                  </span> </span
        ...
        <div class="esa-card__body">
          <div class="cbf-invoice-card cbf-invoice-card--stat">
            <div class="cbf-invoice-card__title-row">
              ...
              <div class="cbf-invoice-card__corner">
                <span class="cbf-invoice-card__status"
                  ><span class="esa-pill esa-pill--warning esa-pill--sm">
                    <span class="esa-pill__label">In review</span>
                  </span> </span
        ...
        <div class="esa-card__body">
          <div class="cbf-invoice-card cbf-invoice-card--stat">
            <div class="cbf-invoice-card__title-row">
              ...
              <div class="cbf-invoice-card__corner">
                <span class="cbf-invoice-card__status"
                  ><span class="esa-pill esa-pill--success esa-pill--sm">
                    <span class="esa-pill__label">Paid</span>
                  </span> </span
        ...
        <div class="esa-card__body">
          <div class="cbf-invoice-card cbf-invoice-card--stat">
            <div class="cbf-invoice-card__title-row">
              ...
              <div class="cbf-invoice-card__corner">
                <span class="cbf-invoice-card__status"
                  ><span class="esa-pill esa-pill--danger esa-pill--sm">
                    <span class="esa-pill__label">Needs revision</span>
                  </span> </span
  ...
  <footer class="cbf-vendor-dashboard-invoices__footer">
    <span class="type-caption" data-invoice-count="">Showing 10 of 10 invoices</span>
  </footer>
      ...
      <div class="cbf-invoice-detail__meta stack" data-gap="lg">
        ...
        <div class="cbf-invoice-detail__hero">
          <div class="cbf-invoice-detail__amount-group">
            ...
            <span
              class="type-page-title cbf-invoice-detail__amount cbf-num"
              data-detail-amount=""
            ></span>
          ...
          <div class="cbf-invoice-detail__revision" data-detail-revision="" hidden="">
            <div class="esa-alert-box esa-alert-box--warning">
              ...
              <div class="esa-alert-box__body">
                <strong class="esa-alert-box__title">Returned for revision</strong>
...
.cbf-invoice-detail__vendor{margin-top:auto;display:flex;flex-direction:column;gap:var(--spacing-400);padding-top:var(--spacing-400);border-top:1px solid var(--color-border)}
...
.esa-alert-box{--_alert-bg: var(--alert-box-bg, var(--color-info-subtle, #eff6ff));--_alert-border: var(--alert-box-border-color, var(--color-info-border, #bfdbfe));--_alert-icon-color: var(--color-info-strong, #0d74ce);--_alert-title-color: var(--alert-box-title-color, var(--color-text-primary, #171717));--_alert-text-color: var(--alert-box-text-color, var(--color-text-secondary, #525252));display:flex;align-items:flex-start;gap:var(--spacing-300, .75rem);padding:var(--alert-box-padding, var(--spacing-300, .75rem) var(--spacing-400, 1rem));border:1px solid var(--_alert-border);border-radius:var(--alert-box-radius, var(--radius-200, .5rem));background:var(--_alert-bg);font-size:var(--type-size-150, .875rem);line-height:1.5}
.esa-alert-box--warning{--_alert-bg: var(--color-warning-subtle, #fffbeb);--_alert-border: var(--color-warning-border, #fde68a);--_alert-icon-color: var(--color-warning-strong, #915930)}
.esa-alert-box__icon{flex-shrink:0;color:var(--_alert-icon-color);padding-top:1px}
.esa-alert-box__body{flex:1;min-width:0}
.esa-alert-box__title{display:block;font-weight:600;color:var(--_alert-title-color);margin-bottom:var(--spacing-050, .125rem)}
...
.esa-pill{--_pill-bg: var(--pill-bg, var(--color-surface-sunken, #efefef));--_pill-text: var(--pill-text-color, var(--color-text-primary, #171717));--_pill-border: var(--pill-border-color, var(--color-border-light, #efefef));--_pill-height: var(--pill-height-md, 28px);--_pill-font-size: 13px;--_pill-padding-x: var(--spacing-200, .5rem);--_pill-gap: var(--spacing-100, .25rem);display:inline-flex;align-items:center;gap:var(--_pill-gap);height:var(--_pill-height);padding-inline:var(--_pill-padding-x);border:1px solid var(--_pill-border);border-radius:var(--pill-radius, var(--radius-full, 9999px));background:var(--_pill-bg);color:var(--_pill-text);font-size:var(--_pill-font-size);line-height:1;white-space:nowrap;box-sizing:border-box}
.esa-pill--info{--_pill-bg: var(--color-info-subtle, var(--color-blue-2));--_pill-text: var(--color-info-strong, #0d74ce);--_pill-border: var(--color-info-border, var(--color-blue-6))}
.esa-pill__label{font-weight:500}
.esa-pill--warning{--_pill-bg: var(--color-warning-subtle, var(--color-yellow-2));--_pill-text: var(--color-warning-strong, #ab6400);--_pill-border: var(--color-warning-border, var(--color-yellow-6))}
.esa-pill--success{--_pill-bg: var(--color-success-subtle, var(--color-lime-2));--_pill-text: var(--color-success-strong, #5c7c2f);--_pill-border: var(--color-success-border, var(--color-lime-6))}
.esa-pill--danger{--_pill-bg: var(--color-danger-subtle, var(--color-red-2));--_pill-text: var(--color-danger-strong, #ce2c31);--_pill-border: var(--color-danger-border, var(--color-red-6))}
