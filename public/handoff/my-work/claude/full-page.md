...
- **Components:** cbf-app-bar (spoke), cbf-app-panel (spoke), cbf-icon (spoke), cbf-invoice-doc (spoke), cbf-invoice-queue-metrics (spoke), cbf-invoice-review-queue (spoke), cbf-logo (spoke), cbf-my-invoices (spoke), cbf-my-portfolio (spoke), cbf-mywork-tabs (spoke), cbf-nav-actions (spoke), cbf-nav-burger (spoke), cbf-nav-collapsible (spoke), cbf-nav-drawer (spoke), cbf-nav-link (spoke), cbf-num (spoke), cbf-omni (spoke), cbf-omni-trigger (spoke), cbf-page (spoke), cbf-pe-band (spoke), cbf-pe-baseline (spoke), cbf-pe-col (spoke), cbf-pe-count (spoke), cbf-pe-crumb-cur (spoke), cbf-pe-detail (spoke), cbf-pe-dot (spoke), cbf-pe-dot-templates (spoke), cbf-pe-empty (spoke), cbf-pe-list (spoke), cbf-pe-pill-templates (spoke), cbf-pe-prompt (spoke), cbf-pe-row (spoke), cbf-portfolio-explorer (spoke), cbf-portfolio-explorer-section (spoke), cbf-portfolio-health (spoke), cbf-review (spoke), cbf-review-attachments (spoke), cbf-review-deadline (spoke), cbf-review-dialog (spoke), cbf-review-docpane (spoke), cbf-review-fields (spoke), cbf-review-footer (spoke), cbf-review-hero (spoke), cbf-review-money (spoke), cbf-review-panel (spoke), cbf-review-process (spoke), cbf-review-split (spoke), cbf-search-field (spoke), cbf-search-surface (spoke), cbf-task-queue (spoke), cbf-task-risk-band (spoke), esa-alert-box (hub), esa-app-bar (hub), esa-badge (hub), esa-breadcrumbs (hub), esa-button (hub), esa-container (hub), esa-empty-state (hub), esa-icon (hub), esa-kbd (hub), esa-link-column (hub), esa-nav-dropdown (hub), esa-page-header (hub), esa-pill (hub), esa-progress-bar (hub), esa-stat (hub)
...
[data-theme="cb-fish"] {
  ...
  --color-background-utility-warning-subtle: #fefdfb;
  ...
  --color-red-2: #fff7f7;
  --color-red-6: #fdbdbe;
  --color-yellow-2: #fefbe9;
  --color-yellow-6: #f3d673;
  ...
  --font-size-600: clamp(1.375rem, 1.2rem + 0.88vw, 1.875rem);
  --icon-size-md: 20px;
  --icon-size-sm: 16px;
  ...
  --typography-microcopy-lg-font-family: "IBM Plex Sans", sans-serif;
  --typography-microcopy-lg-font-size: clamp(0.875rem, 0.77rem + 0.52vw, 1.125rem);
  --typography-microcopy-lg-font-weight: 500;
  --typography-microcopy-lg-letter-spacing: 0.01em;
  --typography-microcopy-lg-line-height: 1;
  --typography-microcopy-lg-subtle-font-family: "IBM Plex Sans", sans-serif;
  --typography-microcopy-lg-subtle-font-size: clamp(0.875rem, 0.77rem + 0.52vw, 1.125rem);
  --typography-microcopy-lg-subtle-font-weight: 400;
  --typography-microcopy-lg-subtle-letter-spacing: 0.01em;
  --typography-microcopy-lg-subtle-line-height: 1;
...
:host([variant="pill"]) .tab--active::after {
  display: none;
}
.panel {
...
| `--tab-layout-height-lg` | `52px` | component |
...
| `--typography-microcopy-lg-font-family` | `"IBM Plex Sans", sans-serif` | semantic |
| `--typography-microcopy-lg-font-size` | `clamp(.875rem, .77rem + .52vw, 1.125rem)` | semantic |
| `--typography-microcopy-lg-font-weight` | `500` | semantic |
| `--typography-microcopy-lg-letter-spacing` | `.01em` | semantic |
| `--typography-microcopy-lg-line-height` | `1` | semantic |
| `--typography-microcopy-lg-subtle-font-family` | `"IBM Plex Sans", sans-serif` | semantic |
| `--typography-microcopy-lg-subtle-font-size` | `clamp(.875rem, .77rem + .52vw, 1.125rem)` | semantic |
| `--typography-microcopy-lg-subtle-font-weight` | `400` | semantic |
| `--typography-microcopy-lg-subtle-letter-spacing` | `.01em` | semantic |
| `--typography-microcopy-lg-subtle-line-height` | `1` | semantic |
