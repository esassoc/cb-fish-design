...
The 108 design tokens this page actually uses, resolved to their final values for the `cb-fish` theme. Component CSS still references them by name (`var(--color-primary)`), so the names carry the intent; the values below are what they currently resolve to.
...
- `--page-header-eyebrow-size`
- `--page-header-gap`
- `--page-header-lede-color`
- `--page-header-lede-size`
