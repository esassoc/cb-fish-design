import"./esa-text-field.astro_astro_type_script_index_0_lang.zjCVt3Qz.js";import"./cbf-legacy-milestones-panel.astro_astro_type_script_index_0_lang.C3dGn_o2.js";import"./cbf-legacy-sow-intro-modal.astro_astro_type_script_index_0_lang.BNeEZbXv.js";import"./cbf-legacy-we-selector.astro_astro_type_script_index_0_lang.Dz7SPXZ_.js";import"./cbf-mywork-tabs.astro_astro_type_script_index_0_lang.-CryuNyB.js";import"./esa-file-upload.DiaxXqAO.js";import{i as r,A as i,b as a,t as s,a as o}from"./typography.C7xuE2z_.js";import{a as n}from"./a11y.c6v_nqwk.js";import{b as l}from"./boolish.DOQu-9JQ.js";import"./announcer.dkeh-00N.js";const c={xs:"label-2xs",sm:"label-xs",md:"label-md",lg:"label-lg"},h={xs:"microcopy-2xs",sm:"microcopy-xs",md:"microcopy-md",lg:"microcopy-lg"};class u extends r{constructor(){super(),this.onInput=e=>{const t=Number(e.target.value);this.value=t,this.internals.setFormValue(String(t)),this.dispatchEvent(new CustomEvent("change",{detail:{value:t},bubbles:!0,composed:!0}))},this.min=0,this.max=100,this.step=1,this.size="md",this.label="",this.showValue=!0,this.disabled=!1,this.value=0,this.internals=this.attachInternals()}static{this.formAssociated=!0}static{this.properties={min:{type:Number},max:{type:Number},step:{type:Number},size:{type:String,reflect:!0},label:{type:String},showValue:{type:Boolean,attribute:"show-value",converter:l},disabled:{type:Boolean,reflect:!0},name:{type:String,reflect:!0},value:{type:Number}}}connectedCallback(){super.connectedCallback(),this.internals.setFormValue(String(this.value))}willUpdate(e){e.has("value")&&this.internals.setFormValue(String(this.value))}get fillPercent(){return this.max===this.min?0:(this.value-this.min)/(this.max-this.min)*100}render(){return a`
