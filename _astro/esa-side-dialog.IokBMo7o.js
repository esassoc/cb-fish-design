import{i as l,b as r,a as d}from"./lit-element.C8p3bJxG.js";import{i as s,u as c}from"./static.CxNnSrf9.js";const n={2:s`h2`,3:s`h3`,4:s`h4`,5:s`h5`,6:s`h6`};class h extends l{constructor(){super(),this.previousFocus=null,this.onKeydown=e=>{e.key==="Escape"?(e.preventDefault(),this.close()):e.key==="Tab"&&this.trapFocus(e)},this.open=!1,this.heading="",this.headingLevel=2,this.position="right",this.size="md",this.showCloseButton=!0,this.closing=!1}static{this.properties={open:{type:Boolean,reflect:!0},heading:{type:String},headingLevel:{type:Number,attribute:"heading-level"},position:{type:String,reflect:!0},size:{type:String,reflect:!0},showCloseButton:{type:Boolean,attribute:"show-close-button"},closing:{state:!0}}}renderTitle(){const e=n[this.headingLevel]??n[2];return c`<${e} class="title">${this.heading}</${e}>`}updated(e){e.has("open")&&(this.open?(this.previousFocus=document.activeElement,requestAnimationFrame(()=>this.focusFirst())):e.get("open")&&this.previousFocus?.focus?.())}show(){clearTimeout(this.closeTimer),this.closing=!1,this.open=!0}close(){this.open&&(this.open=!1,this.closing=!0,clearTimeout(this.closeTimer),this.closeTimer=setTimeout(()=>{this.closing=!1},200),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0})))}focusable(){const e='a[href],button:not([disabled]),input:not([disabled]),select,textarea,[tabindex]:not([tabindex="-1"])',t=this.renderRoot.querySelectorAll(e),o=Array.from(this.querySelectorAll(e));return[...Array.from(t),...o].filter(i=>i.offsetParent!==null)}focusFirst(){const e=this.focusable();e.length?e[0].focus():this.renderRoot.querySelector(".panel")?.focus()}trapFocus(e){const t=this.focusable();if(!t.length)return;const o=t[0],i=t[t.length-1],a=this.renderRoot.activeElement||document.activeElement;e.shiftKey&&a===o?(e.preventDefault(),i.focus()):!e.shiftKey&&a===i&&(e.preventDefault(),o.focus())}render(){if(!this.open&&!this.closing)return r``;const e=!!this.querySelector('[slot="header"]'),t=this.heading||this.showCloseButton||e,o=this.closing&&!this.open;return r`
  ...
  `}}customElements.get("esa-side-dialog")||customElements.define("esa-side-dialog",h);
