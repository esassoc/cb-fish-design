import{M as oe,A as ce,t as se,c as ie}from"./esa-chip-group.DOnIm-Wx.js";import"./esa-button-toggle.CImVxTxI.js";import"./esa-side-dialog.IokBMo7o.js";import"./lit-element.C8p3bJxG.js";import"./static.CxNnSrf9.js";oe.registerModules([ce]);const le=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:2,maximumFractionDigits:2}),X=n=>n.replace(/([()\\])/g,"\\$1");function de(n,m){const S=`BT /F1 18 Tf 60 740 Td (${X(n)}) Tj /F1 11 Tf 0 -26 Td (${X(m)}) Tj 0 -18 Td (Columbia Basin Fish & Wildlife Program — prototype placeholder) Tj ET`,t=["<</Type/Catalog/Pages 2 0 R>>","<</Type/Pages/Kids[3 0 R]/Count 1>>","<</Type/Page/Parent 2 0 R/MediaBox[0 0 612 792]/Resources<</Font<</F1 5 0 R>>>>/Contents 4 0 R>>",`<</Length ${S.length}>>
stream
${S}
