import{i as n,b as r,A as a,t as s,a as l}from"./typography.C7xuE2z_.js";import{b as t}from"./boolish.DOQu-9JQ.js";class c extends n{constructor(){super(),this.onNativeClose=()=>{this.open&&this.dismiss()},this.onLightDismiss=e=>{const o=this.dialogEl;if(!o||!this.open||e.composedPath()[0]!==o)return;const i=o.getBoundingClientRect();i.top<=e.clientY&&e.clientY<=i.top+i.height&&i.left<=e.clientX&&e.clientX<=i.left+i.width||this.dismiss()},this.confirm=()=>this.resolve(!0),this.cancel=()=>this.resolve(!1),this.dismiss=()=>this.resolve(!1,!0),this.open=!1,this.heading="",this.message="",this.variant="default",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.showIcon=!0,this.showCloseButton=!0}static{this.properties={open:{type:Boolean,reflect:!0},heading:{type:String},message:{type:String},variant:{type:String,reflect:!0},confirmLabel:{type:String,attribute:"confirm-label"},cancelLabel:{type:String,attribute:"cancel-label"},showIcon:{type:Boolean,attribute:"show-icon",converter:t},showCloseButton:{type:Boolean,attribute:"show-close-button",converter:t}}}connectedCallback(){super.connectedCallback(),"closedBy"in HTMLDialogElement.prototype||this.addEventListener("click",this.onLightDismiss)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.onLightDismiss)}get dialogEl(){return this.renderRoot.querySelector("dialog")}updated(e){if(!e.has("open"))return;const o=this.dialogEl;o&&(this.open?(o.open||o.showModal(),requestAnimationFrame(()=>{this.renderRoot.querySelector(".esa-confirm-dialog__btn--outline")?.focus()})):o.close())}show(){this.open=!0}resolve(e,o=!1){this.open=!1,o&&this.dispatchEvent(new CustomEvent("dismiss",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(e?"confirm":"cancel",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("resolved",{detail:{confirmed:e,dismissed:o},bubbles:!0,composed:!0}))}icon(){return this.showIcon?this.variant==="danger"?r`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>`:this.variant==="warning"?r`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`:r`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`:null}render(){return r`
      <dialog
  ...
  `]}}customElements.get("esa-confirm-dialog")||customElements.define("esa-confirm-dialog",c);
