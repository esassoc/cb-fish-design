import{i as z,b as s,a as D,A as $}from"./lit-element.C8p3bJxG.js";import"./esa-text-field.astro_astro_type_script_index_0_lang.CxfFO9_Q.js";import"./esa-select.DVtrAvy5.js";import"./esa-checkbox.astro_astro_type_script_index_0_lang.CAN_sttU.js";import"./esa-textarea.astro_astro_type_script_index_0_lang.f3qIukGs.js";class Ze extends z{constructor(){super(),this.onAction=()=>{this.dispatchEvent(new CustomEvent("action",{bubbles:!0,composed:!0})),this.dismiss()},this.dismiss=()=>{this.dispatchEvent(new CustomEvent("dismiss",{bubbles:!0,composed:!0}))},this.message="",this.variant="info",this.action="",this.dismissable=!0,this.icon=""}static{this.properties={message:{type:String},variant:{type:String,reflect:!0},action:{type:String},dismissable:{type:Boolean},icon:{type:String}}}renderIcon(){switch(this.variant){case"success":return s`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>`;case"warning":return s`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`;case"danger":return s`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>`;default:return s`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`}}render(){return s`
  ...
  `}}customElements.get("esa-snackbar-container")||customElements.define("esa-snackbar-container",Ge);class Qe extends z{constructor(){super(),this._suppressNextOpen=!1,this.searchTimer=null,this.lastEmittedSearch="",this.onDocClick=e=>{this._open&&(e.composedPath().includes(this)||this.closeDropdown())},this.onSearchInput=e=>{const r=e.target.value;this._search=r,this._active=-1,this.emitSearch(r),this._open||this.openDropdown()},this.onInputFocus=()=>{if(this._suppressNextOpen){this._suppressNextOpen=!1;return}this._open||this.openDropdown()},this.onInputClick=()=>{this._open||this.openDropdown()},this.onKeydown=e=>{const r=this.filteredOptions;switch(e.key){case"ArrowDown":if(e.preventDefault(),!this._open)return this.openDropdown();{let o=this._active+1;for(;o<r.length&&r[o].disabled;)o++;o<r.length&&(this._active=o)}break;case"ArrowUp":if(e.preventDefault(),!this._open)return this.openDropdown();{let o=this._active-1;for(;o>=0&&r[o].disabled;)o--;o>=0&&(this._active=o)}break;case"Enter":if(e.preventDefault(),this._open&&this._active>=0){const o=r[this._active];o&&!o.disabled&&this.selectOption(o)}else this._open||this.openDropdown();break;case"Escape":e.preventDefault(),this.closeDropdown();break;case"Tab":this.closeDropdown();break}},this.mode="select",this.triggerStyle="field",this.options=[],this.multiple=!1,this.size="md",this.label="",this.placeholder="Select...",this.disabled=!1,this.required=!1,this.helpText="",this.errorText="",this.loading=!1,this.debounceMs=300,this.resultsCount=null,this._search="",this._selected=[],this._open=!1,this._active=-1,this.internals=this.attachInternals()}static{this.formAssociated=!0}static{this.properties={mode:{type:String,reflect:!0},triggerStyle:{type:String,attribute:"trigger-style"},options:{type:Array},multiple:{type:Boolean},size:{type:String,reflect:!0},label:{type:String},placeholder:{type:String},disabled:{type:Boolean,reflect:!0},required:{type:Boolean},helpText:{type:String,attribute:"help-text"},errorText:{type:String,attribute:"error-text"},loading:{type:Boolean},debounceMs:{type:Number,attribute:"debounce-ms"},resultsCount:{type:Number,attribute:"results-count"},_search:{state:!0},_selected:{state:!0},_open:{state:!0},_active:{state:!0}}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this.onDocClick),this.syncFormValue()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this.onDocClick),this.searchTimer&&clearTimeout(this.searchTimer)}set value(e){e==null?this._selected=[]:Array.isArray(e)?this._selected=e:this._selected=[e],this.syncFormValue()}get value(){return this.multiple?this._selected:this._selected[0]??""}get filteredOptions(){const e=this._search.toLowerCase();return e?this.options.filter(r=>r.label.toLowerCase().includes(e)):this.options}get displayValue(){return this._selected.length===0?"":this.multiple?this.options.filter(r=>this._selected.includes(r.value)).map(r=>r.label).join(", "):this.options.find(r=>r.value===this._selected[0])?.label??""}get selectedOptions(){return this.options.filter(e=>this._selected.includes(e.value))}get currentPlaceholder(){return this.multiple&&this._selected.length>0?"":this.placeholder}get inputValue(){return this.multiple?this._search:this._search||this.displayValue}isSelected(e){return this._selected.includes(e)}syncFormValue(){this.internals.setFormValue(this.multiple?this._selected.join(","):this._selected[0]??null)}emitValue(){this.syncFormValue(),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}emitSearch(e){this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>{e!==this.lastEmittedSearch&&(this.lastEmittedSearch=e,this.dispatchEvent(new CustomEvent("search",{detail:{term:e},bubbles:!0,composed:!0})))},this.debounceMs)}toggleDropdown(){this.disabled||(this._open?this.closeDropdown():this.openDropdown())}openDropdown(){this.disabled||this._open||(this._open=!0,this._active=-1,this.mode==="select"&&requestAnimationFrame(()=>{this.renderRoot.querySelector(".search-input")?.focus()}))}closeDropdown(){this._open&&(this._open=!1,this._search="")}selectOption(e){if(e.disabled)return;const r=e.value;if(this.multiple){const o=this._selected.indexOf(r);this._selected=o>=0?this._selected.filter(n=>n!==r):[...this._selected,r],this._search="",this.emitValue();const l=this.mode==="autocomplete"?".input":".search-input";requestAnimationFrame(()=>this.renderRoot.querySelector(l)?.focus())}else this._selected=[r],this._search="",this.emitValue(),this.closeDropdown(),this.mode==="autocomplete"&&(this._suppressNextOpen=!0,requestAnimationFrame(()=>this.renderRoot.querySelector(".input")?.focus()))}removeValue(e,r){r?.stopPropagation(),this._selected=this._selected.filter(o=>o!==e),this.emitValue()}highlight(e){const r=this._search.trim();if(!r)return s`${e}`;const l=e.toLowerCase().indexOf(r.toLowerCase());return l<0?s`${e}`:s`${e.slice(0,l)}<mark class="hl">${e.slice(l,l+r.length)}</mark>${e.slice(l+r.length)}`}render(){const e=!!this.errorText;return s`
    ...
    `}renderChips(){return this.selectedOptions.length===0?$:s`<div class="chips">
  ...
  `}}customElements.get("esa-dialog")||customElements.define("esa-dialog",tt);const oe=["January","February","March","April","May","June","July","August","September","October","November","December"],rt=["Su","Mo","Tu","We","Th","Fr","Sa"],Ae=[];for(let d=1990;d<=2060;d++)Ae.push(d);function ze(d){if(!d)return null;const e=d.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(!e)return null;const r=parseInt(e[1],10),o=parseInt(e[2],10)-1,l=parseInt(e[3],10),n=new Date(r,o,l);return n.getFullYear()!==r||n.getMonth()!==o||n.getDate()!==l?null:n}function De(d){return`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}-${String(d.getDate()).padStart(2,"0")}`}function ae(d,e){return d.getFullYear()===e.getFullYear()&&d.getMonth()===e.getMonth()&&d.getDate()===e.getDate()}function se(d){return`${String(d.getMonth()+1).padStart(2,"0")}/${String(d.getDate()).padStart(2,"0")}/${d.getFullYear()}`}function U(d){const e=d.trim();if(!e)return null;const r=e.match(/^(\d{1,2})\/(\d{1,2})\/(\d{2,4})$/);if(r){const l=r[3].length===2?2e3+parseInt(r[3]):parseInt(r[3]),n=new Date(l,parseInt(r[1])-1,parseInt(r[2]));if(n.getMonth()===parseInt(r[1])-1&&n.getDate()===parseInt(r[2]))return n}const o=new Date(e);return isNaN(o.getTime())?null:o}function it(d,e=!1){const r=d.slice(0,8);return r.length===0?"":r.length<2?r:r.length===2?e?r:`${r}/`:r.length<4?`${r.slice(0,2)}/${r.slice(2)}`:r.length===4?e?`${r.slice(0,2)}/${r.slice(2)}`:`${r.slice(0,2)}/${r.slice(2)}/`:`${r.slice(0,2)}/${r.slice(2,4)}/${r.slice(4)}`}class ot extends z{static formAssociated=!0;static properties={label:{type:String},placeholder:{type:String},required:{type:Boolean},disabled:{type:Boolean,reflect:!0},errorText:{type:String,attribute:"error-text"},helpText:{type:String,attribute:"help-text"},value:{type:String},_open:{state:!0},_viewYear:{state:!0},_viewMonth:{state:!0},_monthOpen:{state:!0},_yearOpen:{state:!0},_monthSearch:{state:!0},_yearSearch:{state:!0},_inputText:{state:!0}};internals;_onDocClick=e=>{this._open&&!e.composedPath().includes(this)&&this._close()};_onSiblingOpen=e=>{e.detail?.source!==this&&this._open&&this._close()};constructor(){super(),this.label="",this.placeholder="MM/DD/YYYY",this.required=!1,this.disabled=!1,this.errorText="",this.helpText="",this.value="";const e=new Date;this._viewYear=e.getFullYear(),this._viewMonth=e.getMonth(),this._open=!1,this._monthOpen=!1,this._yearOpen=!1,this._monthSearch="",this._yearSearch="",this._inputText="",this.internals=this.attachInternals()}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick),document.addEventListener("bcn-date-picker:open",this._onSiblingOpen)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick),document.removeEventListener("bcn-date-picker:open",this._onSiblingOpen)}updated(e){if(e.has("value")){this.internals.setFormValue(this.value||null);const r=ze(this.value);if(r){this._viewYear=r.getFullYear(),this._viewMonth=r.getMonth();const o=U(this._inputText);(!o||!ae(o,r))&&(this._inputText=se(r))}else this.value||(this._inputText="")}}_calendarCells(){const e=new Date(this._viewYear,this._viewMonth,1),r=new Date(this._viewYear,this._viewMonth+1,0).getDate(),o=[];for(let l=0;l<e.getDay();l++)o.push(null);for(let l=1;l<=r;l++)o.push(new Date(this._viewYear,this._viewMonth,l));for(;o.length%7!==0;)o.push(null);return o}_onTextInput(e){const r=e.target,o=e.inputType==="insertFromPaste",l=e.inputType?.startsWith("delete")??!1;let n;if(o){const h=U(r.value);n=h?se(h):r.value}else{const h=r.value.replace(/\D/g,"").slice(0,8);n=it(h,l)}r.value=n,this._inputText=n;const u=U(n);u?(this.value=De(u),this.internals.setFormValue(this.value),this._viewYear=u.getFullYear(),this._viewMonth=u.getMonth(),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))):n||(this.value="",this.internals.setFormValue(null),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}_onTextBlur(){if(!this._inputText)return;const e=U(this._inputText);e&&(this._inputText=se(e))}_toggle(e){e.stopPropagation(),!this.disabled&&(this._open=!this._open,this._open?document.dispatchEvent(new CustomEvent("bcn-date-picker:open",{detail:{source:this}})):this._closeNavDropdowns())}_close(){this._open=!1,this._closeNavDropdowns()}_closeNavDropdowns(){this._monthOpen=!1,this._yearOpen=!1,this._monthSearch="",this._yearSearch=""}_toggleMonth(e){e.stopPropagation(),this._monthOpen=!this._monthOpen,this._yearOpen=!1,this._monthSearch="",this._monthOpen&&this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".cal-nav__search--month")?.focus()})}_toggleYear(e){e.stopPropagation(),this._yearOpen=!this._yearOpen,this._monthOpen=!1,this._yearSearch="",this._yearOpen&&this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".cal-nav__search--year")?.focus(),this.shadowRoot?.querySelector(".cal-nav__option.is-selected")?.scrollIntoView({block:"nearest"})})}_selectMonth(e,r){r.stopPropagation(),this._viewMonth=e,this._monthOpen=!1,this._monthSearch=""}_selectYear(e,r){r.stopPropagation(),this._viewYear=e,this._yearOpen=!1,this._yearSearch=""}_selectDay(e){this.value=De(e),this.internals.setFormValue(this.value),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this._close()}_selectToday(){const e=new Date;e.setHours(0,0,0,0),this._selectDay(e)}_onKeyDown(e){e.key==="Escape"&&(this._monthOpen||this._yearOpen?(this._closeNavDropdowns(),e.stopPropagation()):this._open&&(this._close(),e.stopPropagation()))}_onCalendarClick(e){if(!this._monthOpen&&!this._yearOpen)return;const r=e.composedPath();let o=!1;this.shadowRoot?.querySelectorAll(".cal-nav").forEach(l=>{r.includes(l)&&(o=!0)}),o||this._closeNavDropdowns()}_renderMonthCombo(){const e=oe.filter(r=>r.toLowerCase().includes(this._monthSearch.toLowerCase()));return s`
      ...
      </div>`}_renderYearCombo(){const e=Ae.filter(r=>String(r).includes(this._yearSearch));return s`
      ...
      </div>`}render(){const e=ze(this.value),r=new Date;r.setHours(0,0,0,0);const o=this._calendarCells(),l=!!this.errorText;return s`
      <div class="field" @keydown=${this._onKeyDown}>

        ${this.label?s`
          <label class="field__label" @click=${()=>this.shadowRoot?.querySelector(".date-input")?.focus()}>
            ${this.label}${this.required?s`<span class="field__req" aria-hidden="true">&thinsp;*</span>`:$}
          </label>`:$}
          ...
          ${this._open?s`
            <div class="calendar" role="dialog" aria-label="Date picker"
              ...
              <div class="calendar__weekdays">
                ${rt.map(n=>s`<span class="calendar__weekday">${n}</span>`)}
              </div>
        ...
        ${l?s`<p class="field__message field__message--error" role="alert">${this.errorText}</p>`:this.helpText?s`<p class="field__message">${this.helpText}</p>`:$}
  ...
  `}customElements.define("bcn-date-picker",ot);function at(){const d=document.querySelector("[data-invoice-wizard]");if(!d)return;const e=d,r=e.querySelector("[data-stepper]"),o=Array.from(e.querySelectorAll("[data-stepper-step]")),l=Array.from(e.querySelectorAll(".cbf-stepper__line"));let n=0;const u=2,h=e.querySelector("[data-pdf-panel]"),O=e.querySelector("[data-pdf-frame]"),ne=e.querySelector("[data-pdf-filename]"),Le=e.querySelector(".cbf-invoice-workspace");function S(t,i){e.querySelectorAll(`[data-step="${t}"]`).forEach(a=>{i?a.removeAttribute("hidden"):a.setAttribute("hidden","")})}function H(t){if(!(t!==u&&!Me(n))){if(n===0&&t===1&&Re()){Ve(()=>H(t));return}if(t===1&&de()==="modal"){Te();return}S(n,!1),n=t,S(n,!0),W(),n===1&&qe(),E(),window.scrollTo({top:0,behavior:"smooth"})}}function Te(){const t=e.querySelector("[data-confirm-modal]");t&&(He(),t.show())}function W(){const t=n>=o.length;r?.toggleAttribute("hidden",t),!t&&(o.forEach((i,a)=>{i.classList.toggle("is-active",a===n),i.classList.toggle("is-done",a<n)}),l.forEach((i,a)=>{i.style.background=a<n?"var(--color-primary)":"var(--color-border)"}))}let le="page";const ce=e.querySelector("[data-confirm-mode-bar]");ce?.addEventListener("click",t=>{const i=t.target.closest("[data-confirm-mode]");if(!i)return;const a=i.dataset.confirmMode;a&&(le=a,ce.querySelectorAll("[data-confirm-mode]").forEach(c=>{c.classList.toggle("is-active",c.dataset.confirmMode===a)}))});function de(){return le}function ue(){if(!b){const i=new File([`%PDF-1.4
% demo invoice for testing
`],"demo-invoice.pdf",{type:"application/pdf"});j(i)}const t=(i,a)=>{const c=e.querySelector(i);c&&(c.value=a,c.dispatchEvent(new Event("input",{bubbles:!0})),c.dispatchEvent(new Event("change",{bubbles:!0})))};t('[data-field="contract"]',"CON-2025-0112"),t('[data-field="invoice-number"]',"INV-2026-0042"),t('[data-field="invoice-date"]',"2026-06-29"),t('[data-field="perf-start"]',"2026-01-01"),t('[data-field="perf-end"]',"2026-03-31"),t('[data-field="total-amount"]',"4850.00"),t('[data-field="notes"]',"Autofilled demo invoice (testing)."),H(1)}window.vendorInvoiceAutofill=ue,e.addEventListener("click",t=>{const i=t.target;i.closest("[data-wizard-next]")&&H(n+1),i.closest("[data-wizard-back]")&&n>0&&(S(n,!1),n--,S(n,!0),W(),E()),i.closest("[data-wizard-save-draft]")&&We(),i.closest("[data-wizard-submit]")&&Ce(),i.closest("[data-modal-submit]")&&Ce(),i.closest("[data-modal-back]")&&e.querySelector("[data-confirm-modal]")?.close(),i.closest("[data-wizard-cancel]")&&(e.querySelector("[data-confirm-modal]")?.close(),window.location.href="/cb-fish-design/vendor-dashboard"),i.closest("[data-dev-autofill]")&&ue()}),E(),e.querySelectorAll("[data-combobox-options]").forEach(t=>{try{t.options=JSON.parse(t.dataset.comboboxOptions??"[]")}catch{}});function E(){const t=n===0;h?.toggleAttribute("hidden",!t),Le?.classList.toggle("has-pdf",t)}function Me(t){if(t===0){const i=Fe(),a=Ie();return i&&a}return!0}function Fe(){const t=e.querySelector('[data-step-error="upload"]'),i=!!b;return t?.toggleAttribute("hidden",i),i}function Ie(){let t=!0;[e.querySelector('[data-field="invoice-number"]'),e.querySelector('[data-field="invoice-date"]'),e.querySelector('[data-field="perf-start"]'),e.querySelector('[data-field="perf-end"]'),e.querySelector('[data-field="contract"]')].forEach(k=>{if(!k)return;(k.value??k.getAttribute("value")??"").trim()?k.removeAttribute("error-text"):(k.setAttribute("error-text","This field is required."),t=!1)});const a=e.querySelector('[data-field="perf-start"]'),c=e.querySelector('[data-field="perf-end"]'),p=a?.value??"",F=c?.value??"";p&&F&&p>F&&(c?.setAttribute("error-text","End date must be on or after start date."),t=!1);const I=e.querySelector('[data-step-error="total"]'),w=e.querySelector('[data-step-error="total-exceeds"]');return ee()<=0?(t=!1,I?.removeAttribute("hidden"),w?.setAttribute("hidden",""),v?.setAttribute("error-text","Enter the invoice total amount.")):(I?.setAttribute("hidden",""),_e()?(t=!1,R()):(w?.setAttribute("hidden",""),v?.removeAttribute("error-text"))),t}let A=!1;function J(){const t=!A;e.querySelector("[data-form-lock-notice]")?.toggleAttribute("hidden",!t),e.querySelectorAll("[data-field]:not([data-readonly])").forEach(i=>{i.toggleAttribute("disabled",t)}),e.querySelector("[data-add-line-item]")?.toggleAttribute("disabled",t),e.querySelector("[data-docs-add]")?.toggleAttribute("disabled",t),e.querySelectorAll(".cbf-li-input").forEach(i=>{i.disabled=t}),e.querySelectorAll(".cbf-li-remove").forEach(i=>{i.disabled=t})}J();let b=null;const q=e.querySelector("[data-upload-zone]"),B=e.querySelector("[data-upload-input]"),L=e.querySelector("[data-mobile-upload-input]"),pe=e.querySelector("[data-upload-idle]"),he=e.querySelector("[data-pdf-viewer]");let _=null;const X=25*1024*1024;function Oe(t){const i=e.querySelector("[data-upload-inline-error]"),a=e.querySelector("[data-upload-inline-error-msg]");a&&(a.textContent=t),i?.removeAttribute("hidden")}function Be(){e.querySelector("[data-upload-inline-error]")?.setAttribute("hidden","")}function je(t){return t.type==="application/pdf"||t.name.toLowerCase().endsWith(".pdf")?t.size>X?`This file is ${P(t.size)} — the maximum is 25 MB. Please upload a smaller PDF.`:null:"That file isn’t a PDF. Please upload a PDF invoice."}function j(t){const i=je(t);if(i){Oe(i);return}Be(),b=t,pe?.setAttribute("hidden",""),he?.removeAttribute("hidden"),e.querySelector('[data-step-error="upload"]')?.setAttribute("hidden",""),A||(A=!0,J()),_&&URL.revokeObjectURL(_),_=URL.createObjectURL(t),O&&(O.src=_),ne&&(ne.textContent=t.name),n===1&&qe(),E()}function fe(){b=null,B.value="",L&&(L.value=""),he?.setAttribute("hidden",""),pe?.removeAttribute("hidden"),_&&(URL.revokeObjectURL(_),_=null),O&&(O.src=""),E()}let y=[];const N=e.querySelector("[data-docs-input]"),Z=e.querySelector("[data-docs-list]");function G(){Z&&(Z.innerHTML=y.map((t,i)=>`
    ...
    `).join(""))}e.querySelector("[data-docs-add]")?.addEventListener("click",()=>N?.click());function ve(t){const i=e.querySelector("[data-docs-error]"),a=e.querySelector("[data-docs-error-msg]");t?(a&&(a.textContent=t),i?.removeAttribute("hidden")):i?.setAttribute("hidden","")}function ge(t){if(!t.length)return;const i=t.filter(c=>c.size>X),a=new Set(y.map(c=>c.name));if(y.push(...t.filter(c=>c.size<=X&&!a.has(c.name))),i.length){const c=i.map(p=>p.name).join(", ");ve(`${c} ${i.length>1?"each exceed":"exceeds"} the 25 MB limit and ${i.length>1?"were":"was"} not added.`)}else ve("");G()}N?.addEventListener("change",()=>{ge(Array.from(N.files??[])),N.value=""});const x=e.querySelector("[data-docs-zone]");x?.addEventListener("dragover",t=>{t.preventDefault(),x.classList.add("is-over")}),x?.addEventListener("dragleave",t=>{x.contains(t.relatedTarget)||x.classList.remove("is-over")}),x?.addEventListener("drop",t=>{t.preventDefault(),x.classList.remove("is-over"),ge(Array.from(t.dataTransfer?.files??[]))}),Z?.addEventListener("click",t=>{const i=t.target.closest("[data-doc-remove]");i&&(y.splice(Number(i.dataset.docRemove),1),G())}),e.querySelector("[data-upload-browse]")?.addEventListener("click",()=>B.click()),e.querySelector("[data-upload-remove]")?.addEventListener("click",fe),e.querySelector("[data-mobile-upload-btn]")?.addEventListener("click",()=>L?.click()),B.addEventListener("change",()=>{const t=B.files?.[0];t&&j(t)}),L?.addEventListener("change",()=>{const t=L.files?.[0];t&&j(t)}),q.addEventListener("dragover",t=>{t.preventDefault(),q.classList.add("is-over")}),q.addEventListener("dragleave",()=>q.classList.remove("is-over")),q.addEventListener("drop",t=>{t.preventDefault(),q.classList.remove("is-over");const i=t.dataTransfer?.files?.[0];i&&j(i)});function P(t){return t<1024*1024?`${(t/1024).toFixed(0)} KB`:`${(t/(1024*1024)).toFixed(1)} MB`}function Q(t){if(!t)return"—";const i=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t),a=i?new Date(Number(i[1]),Number(i[2])-1,Number(i[3])):new Date(t);return Number.isNaN(a.getTime())?t:a.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}let f=[];const Y=e.querySelector("[data-line-items]"),me=e.querySelector("[data-invoice-total]"),v=e.querySelector('[data-field="total-amount"]');function ee(){const t=String(v?.value??"").replace(/[^0-9.]/g,""),i=parseFloat(t);return Number.isFinite(i)&&i>0?i:0}function be(){const t=te[m?.value??""];return t?t.remaining:null}function _e(){const t=be();return t!=null&&ee()>t}function R(){const t=e.querySelector('[data-step-error="total-exceeds"]'),i=be();if(i!=null&&_e()){const a=t?.querySelector("[data-remaining-amount]");a&&(a.textContent=T(i)),t?.removeAttribute("hidden"),v?.setAttribute("error-text","Exceeds the remaining contract balance.")}else t?.setAttribute("hidden",""),v?.getAttribute("error-text")==="Exceeds the remaining contract balance."&&v.removeAttribute("error-text")}function ye(){f.push({description:"",qty:1,unitPrice:0}),xe()}function Ne(t){f.splice(t,1),xe()}function xe(){const t=A?"":" disabled";Y.innerHTML=f.map((i,a)=>`
    ...
    `).join(""),we()}function we(){const t=f.reduce((i,a)=>i+a.qty*a.unitPrice,0);me&&(me.textContent=T(t))}function T(t){return t.toLocaleString("en-US",{style:"currency",currency:"USD"})}function V(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}Y.addEventListener("input",t=>{const i=t.target,a=Number(i.dataset.liIdx),c=i.dataset.liField;if(!c||isNaN(a))return;c==="description"&&(f[a].description=i.value),c==="qty"&&(f[a].qty=Math.max(1,Number(i.value)||1)),c==="unitPrice"&&(f[a].unitPrice=Math.max(0,Number(i.value)||0));const p=Y.querySelector(`[data-li-total="${a}"]`);p&&(p.textContent=T(f[a].qty*f[a].unitPrice)),we()}),Y.addEventListener("click",t=>{const i=t.target.closest("[data-li-remove]");i&&Ne(Number(i.dataset.liRemove))}),e.querySelector("[data-add-line-item]")?.addEventListener("click",ye);const g=e.querySelector("[data-final-invoice]"),Pe=e.querySelector("[data-final-invoice-callout]"),M=e.querySelector("[data-final-invoice-dialog]"),m=e.querySelector('[data-field="contract"]');let te={};try{te=JSON.parse(m?.dataset.contractAmounts??"{}")}catch{}v?.addEventListener("input",R),v?.addEventListener("change",R),m?.addEventListener("change",R);const ke=e.querySelector('[data-field="project"]');let $e={};try{$e=JSON.parse(m?.dataset.contractProjects??"{}")}catch{}m?.addEventListener("change",()=>{ke&&(ke.value=$e[m.value??""]??"")});function re(){Pe?.classList.toggle("is-flagged",!!g?.checked)}let K=!1;g?.addEventListener("change",()=>{K=!0,re()});function Se(){return ee()}function Ye(){const t=te[m?.value??""],i=Se();if(!t||i<=0)return!1;const a=t.remaining-i;return a>=0&&a<.05*t.total}function Re(){return!!g&&!K&&!g.checked&&Ye()}function Ve(t){if(!M){t();return}const i=m?.value||"this contract";M.message=`The remaining balance on ${i} is within 5% of this invoice's total, which usually means it's the last one. Marking it final closes out the contract — should we flag this as the final invoice?`;const a=c=>{M.removeEventListener("resolved",a),!c.detail?.dismissed&&(K=!0,c.detail?.confirmed&&(g.checked=!0,re()),t())};M.addEventListener("resolved",a),M.show()}ye();function C(t){return e.querySelector(t)?.value??""}function Ke(t){const i=e.querySelector(t);if(!i)return"";const a=i.value??"";return i.options?.find(p=>p.value===a)?.label??a}const Ue='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>';function Ee(t){if(!t)return;const i=(w,k)=>{const ie=t.querySelector(`[data-review="${w}"]`);ie&&(ie.textContent=k)};i("file-name",b?.name??"(no file)"),i("file-size",b?P(b.size):""),i("invoice-number",C('[data-field="invoice-number"]')||"No invoice number"),i("contract",Ke('[data-field="contract"]')||"—"),i("project",C('[data-field="project"]')||"—");const a=C('[data-field="invoice-date"]');i("issued",a?Q(a):"Not set");const c=C('[data-field="perf-start"]'),p=C('[data-field="perf-end"]');i("perf-start",c?Q(c):"Not set"),i("perf-end",p?Q(p):"Not set"),i("total",T(Se())),t.querySelector('[data-review="final-flag"]')?.toggleAttribute("hidden",!g?.checked);const F=t.querySelector('[data-review="docs-list"]');F&&(F.innerHTML=y.map(w=>`
        <div class="cbf-review-row">
          ${Ue}
          <span>${V(w.name)}</span>
          <span class="cbf-review-meta">${P(w.size)}</span>
        </div>`).join("")),t.querySelector('[data-review="docs-card"]')?.toggleAttribute("hidden",y.length===0);const I=C('[data-field="notes"]');i("notes",I),t.querySelector('[data-review="notes-card"]')?.toggleAttribute("hidden",!I)}function qe(){Ee(e.querySelector("[data-review-content]"))}function He(){Ee(e.querySelector("[data-modal-review-content]"))}function We(){document.querySelector("[data-snackbar]")?.success?.("Draft saved.",{duration:3e3}),setTimeout(()=>{window.location.href="/cb-fish-design/vendor-dashboard"},700)}function Ce(){const t=de()==="modal",i=t?"[data-modal-submit]":"[data-wizard-submit]",a=e.querySelector(`${i} button.esa-button`);if(a){if(a.classList.add("esa-button--loading"),a.disabled=!0,a.setAttribute("aria-busy","true"),!a.querySelector(".esa-button__spinner")){const c=document.createElement("span");c.className="esa-button__spinner",c.setAttribute("aria-hidden","true"),a.prepend(c)}a.querySelector(".esa-button__label")?.classList.add("esa-button__label--hidden")}setTimeout(()=>{const c=`INV-${new Date().getFullYear()}-${String(Math.floor(Math.random()*9e4)+1e4)}`;Je(a),t&&e.querySelector("[data-confirm-modal]")?.close(),Xe(),document.querySelector("[data-snackbar]")?.success?.(`Invoice ${c} submitted.`,{duration:4e3})},1500)}function Je(t){t&&(t.classList.remove("esa-button--loading"),t.disabled=!1,t.removeAttribute("aria-busy"),t.querySelector(".esa-button__spinner")?.remove(),t.querySelector(".esa-button__label")?.classList.remove("esa-button__label--hidden"))}function Xe(){fe(),y=[],G(),e.querySelectorAll("[data-field]").forEach(t=>{typeof t.checked=="boolean"&&(t.checked=!1),t.value="",t.removeAttribute?.("error-text")}),e.querySelectorAll("[data-step-error]").forEach(t=>t.setAttribute("hidden","")),K=!1,g&&(g.checked=!1),re(),A=!1,J(),S(n,!1),n=0,S(0,!0),W(),E(),window.scrollTo({top:0,behavior:"smooth"})}}at();
