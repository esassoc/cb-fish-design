import"./baselines.astro_astro_type_script_index_0_lang.BfuPGaUe.js";import"./esa-text-field.astro_astro_type_script_index_0_lang.CxfFO9_Q.js";import"./esa-select.DVtrAvy5.js";import{i as de,b as s,A,a as ce}from"./lit-element.C8p3bJxG.js";import"./esa-checkbox.astro_astro_type_script_index_0_lang.CAN_sttU.js";import"./esa-confirm-dialog.D3bTJpoB.js";import{i as B,u as dt}from"./static.CxNnSrf9.js";import"./esa-textarea.astro_astro_type_script_index_0_lang.f3qIukGs.js";class ct extends de{constructor(){super(),this._suppressNextOpen=!1,this.searchTimer=null,this.lastEmittedSearch="",this.onDocClick=e=>{this._open&&(e.composedPath().includes(this)||this.closeDropdown())},this.onSearchInput=e=>{const r=e.target.value;this._search=r,this._active=-1,this.emitSearch(r),this._open||this.openDropdown()},this.onInputFocus=()=>{if(this._suppressNextOpen){this._suppressNextOpen=!1;return}this._open||this.openDropdown()},this.onInputClick=()=>{this._open||this.openDropdown()},this.onKeydown=e=>{const r=this.filteredOptions;switch(e.key){case"ArrowDown":if(e.preventDefault(),!this._open)return this.openDropdown();{let a=this._active+1;for(;a<r.length&&r[a].disabled;)a++;a<r.length&&(this._active=a)}break;case"ArrowUp":if(e.preventDefault(),!this._open)return this.openDropdown();{let a=this._active-1;for(;a>=0&&r[a].disabled;)a--;a>=0&&(this._active=a)}break;case"Enter":if(e.preventDefault(),this._open&&this._active>=0){const a=r[this._active];a&&!a.disabled&&this.selectOption(a)}else this._open||this.openDropdown();break;case"Escape":e.preventDefault(),this.closeDropdown();break;case"Tab":this.closeDropdown();break}},this.mode="select",this.triggerStyle="field",this.options=[],this.multiple=!1,this.size="md",this.label="",this.placeholder="Select...",this.disabled=!1,this.required=!1,this.helpText="",this.errorText="",this.loading=!1,this.debounceMs=300,this.resultsCount=null,this._search="",this._selected=[],this._open=!1,this._active=-1,this.internals=this.attachInternals()}static{this.formAssociated=!0}static{this.properties={mode:{type:String,reflect:!0},triggerStyle:{type:String,attribute:"trigger-style"},options:{type:Array},multiple:{type:Boolean},size:{type:String,reflect:!0},label:{type:String},placeholder:{type:String},disabled:{type:Boolean,reflect:!0},required:{type:Boolean},helpText:{type:String,attribute:"help-text"},errorText:{type:String,attribute:"error-text"},loading:{type:Boolean},debounceMs:{type:Number,attribute:"debounce-ms"},resultsCount:{type:Number,attribute:"results-count"},_search:{state:!0},_selected:{state:!0},_open:{state:!0},_active:{state:!0}}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this.onDocClick),this.syncFormValue()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this.onDocClick),this.searchTimer&&clearTimeout(this.searchTimer)}set value(e){e==null?this._selected=[]:Array.isArray(e)?this._selected=e:this._selected=[e],this.syncFormValue()}get value(){return this.multiple?this._selected:this._selected[0]??""}get filteredOptions(){const e=this._search.toLowerCase();return e?this.options.filter(r=>r.label.toLowerCase().includes(e)):this.options}get displayValue(){return this._selected.length===0?"":this.multiple?this.options.filter(r=>this._selected.includes(r.value)).map(r=>r.label).join(", "):this.options.find(r=>r.value===this._selected[0])?.label??""}get selectedOptions(){return this.options.filter(e=>this._selected.includes(e.value))}get currentPlaceholder(){return this.multiple&&this._selected.length>0?"":this.placeholder}get inputValue(){return this.multiple?this._search:this._search||this.displayValue}isSelected(e){return this._selected.includes(e)}syncFormValue(){this.internals.setFormValue(this.multiple?this._selected.join(","):this._selected[0]??null)}emitValue(){this.syncFormValue(),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}emitSearch(e){this.searchTimer&&clearTimeout(this.searchTimer),this.searchTimer=setTimeout(()=>{e!==this.lastEmittedSearch&&(this.lastEmittedSearch=e,this.dispatchEvent(new CustomEvent("search",{detail:{term:e},bubbles:!0,composed:!0})))},this.debounceMs)}toggleDropdown(){this.disabled||(this._open?this.closeDropdown():this.openDropdown())}openDropdown(){this.disabled||this._open||(this._open=!0,this._active=-1,this.mode==="select"&&requestAnimationFrame(()=>{this.renderRoot.querySelector(".search-input")?.focus()}))}closeDropdown(){this._open&&(this._open=!1,this._search="")}selectOption(e){if(e.disabled)return;const r=e.value;if(this.multiple){const a=this._selected.indexOf(r);this._selected=a>=0?this._selected.filter(n=>n!==r):[...this._selected,r],this._search="",this.emitValue();const l=this.mode==="autocomplete"?".input":".search-input";requestAnimationFrame(()=>this.renderRoot.querySelector(l)?.focus())}else if(this._selected=[r],this._search="",this.emitValue(),this.closeDropdown(),this.mode==="autocomplete"){const a=this.renderRoot.querySelector(".input");a&&this.renderRoot.activeElement!==a&&(this._suppressNextOpen=!0,requestAnimationFrame(()=>a.focus()))}}removeValue(e,r){r?.stopPropagation(),this._selected=this._selected.filter(a=>a!==e),this.emitValue()}highlight(e){const r=this._search.trim();if(!r)return s`${e}`;const l=e.toLowerCase().indexOf(r.toLowerCase());return l<0?s`${e}`:s`${e.slice(0,l)}<mark class="hl">${e.slice(l,l+r.length)}</mark>${e.slice(l+r.length)}`}render(){const e=!!this.errorText;return s`
    ...
    `}renderChips(){return this.selectedOptions.length===0?A:s`<div class="chips">
      ...
      stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12a9 9 0 1 1-6.219-8.56" /></svg>`}static{this.styles=ce`
    :host {
      display: block;
  ...
  `}}customElements.get("esa-dialog")||customElements.define("esa-dialog",ut);const ne=["January","February","March","April","May","June","July","August","September","October","November","December"],pt=["Su","Mo","Tu","We","Th","Fr","Sa"],Oe=[];for(let c=1990;c<=2060;c++)Oe.push(c);function Fe(c){if(!c)return null;const e=c.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(!e)return null;const r=parseInt(e[1],10),a=parseInt(e[2],10)-1,l=parseInt(e[3],10),n=new Date(r,a,l);return n.getFullYear()!==r||n.getMonth()!==a||n.getDate()!==l?null:n}function Ne(c){return`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}-${String(c.getDate()).padStart(2,"0")}`}function se(c,e){return c.getFullYear()===e.getFullYear()&&c.getMonth()===e.getMonth()&&c.getDate()===e.getDate()}function le(c){return`${String(c.getMonth()+1).padStart(2,"0")}/${String(c.getDate()).padStart(2,"0")}/${c.getFullYear()}`}function Z(c){const e=c.trim();if(!e)return null;const r=e.match(/^(\d{1,2})\/(\d{1,2})\/(\d{2,4})$/);if(r){const l=r[3].length===2?2e3+parseInt(r[3]):parseInt(r[3]),n=new Date(l,parseInt(r[1])-1,parseInt(r[2]));if(n.getMonth()===parseInt(r[1])-1&&n.getDate()===parseInt(r[2]))return n}const a=new Date(e);return isNaN(a.getTime())?null:a}function ht(c,e=!1){const r=c.slice(0,8);return r.length===0?"":r.length<2?r:r.length===2?e?r:`${r}/`:r.length<4?`${r.slice(0,2)}/${r.slice(2)}`:r.length===4?e?`${r.slice(0,2)}/${r.slice(2)}`:`${r.slice(0,2)}/${r.slice(2)}/`:`${r.slice(0,2)}/${r.slice(2,4)}/${r.slice(4)}`}class ft extends de{static formAssociated=!0;static properties={label:{type:String},placeholder:{type:String},required:{type:Boolean},disabled:{type:Boolean,reflect:!0},errorText:{type:String,attribute:"error-text"},helpText:{type:String,attribute:"help-text"},value:{type:String},_open:{state:!0},_viewYear:{state:!0},_viewMonth:{state:!0},_monthOpen:{state:!0},_yearOpen:{state:!0},_monthSearch:{state:!0},_yearSearch:{state:!0},_inputText:{state:!0}};internals;_onDocClick=e=>{this._open&&!e.composedPath().includes(this)&&this._close()};_onSiblingOpen=e=>{e.detail?.source!==this&&this._open&&this._close()};constructor(){super(),this.label="",this.placeholder="MM/DD/YYYY",this.required=!1,this.disabled=!1,this.errorText="",this.helpText="",this.value="";const e=new Date;this._viewYear=e.getFullYear(),this._viewMonth=e.getMonth(),this._open=!1,this._monthOpen=!1,this._yearOpen=!1,this._monthSearch="",this._yearSearch="",this._inputText="",this.internals=this.attachInternals()}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick),document.addEventListener("bcn-date-picker:open",this._onSiblingOpen)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick),document.removeEventListener("bcn-date-picker:open",this._onSiblingOpen)}updated(e){if(e.has("value")){this.internals.setFormValue(this.value||null);const r=Fe(this.value);if(r){this._viewYear=r.getFullYear(),this._viewMonth=r.getMonth();const a=Z(this._inputText);(!a||!se(a,r))&&(this._inputText=le(r))}else this.value||(this._inputText="")}}_calendarCells(){const e=new Date(this._viewYear,this._viewMonth,1),r=new Date(this._viewYear,this._viewMonth+1,0).getDate(),a=[];for(let l=0;l<e.getDay();l++)a.push(null);for(let l=1;l<=r;l++)a.push(new Date(this._viewYear,this._viewMonth,l));for(;a.length%7!==0;)a.push(null);return a}_onTextInput(e){const r=e.target,a=e.inputType==="insertFromPaste",l=e.inputType?.startsWith("delete")??!1;let n;if(a){const h=Z(r.value);n=h?le(h):r.value}else{const h=r.value.replace(/\D/g,"").slice(0,8);n=ht(h,l)}r.value=n,this._inputText=n;const g=Z(n);g?(this.value=Ne(g),this.internals.setFormValue(this.value),this._viewYear=g.getFullYear(),this._viewMonth=g.getMonth(),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))):n||(this.value="",this.internals.setFormValue(null),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}_onTextBlur(){if(!this._inputText)return;const e=Z(this._inputText);e&&(this._inputText=le(e))}_toggle(e){e.stopPropagation(),!this.disabled&&(this._open=!this._open,this._open?document.dispatchEvent(new CustomEvent("bcn-date-picker:open",{detail:{source:this}})):this._closeNavDropdowns())}_close(){this._open=!1,this._closeNavDropdowns()}_closeNavDropdowns(){this._monthOpen=!1,this._yearOpen=!1,this._monthSearch="",this._yearSearch=""}_toggleMonth(e){e.stopPropagation(),this._monthOpen=!this._monthOpen,this._yearOpen=!1,this._monthSearch="",this._monthOpen&&this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".cal-nav__search--month")?.focus()})}_toggleYear(e){e.stopPropagation(),this._yearOpen=!this._yearOpen,this._monthOpen=!1,this._yearSearch="",this._yearOpen&&this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".cal-nav__search--year")?.focus(),this.shadowRoot?.querySelector(".cal-nav__option.is-selected")?.scrollIntoView({block:"nearest"})})}_selectMonth(e,r){r.stopPropagation(),this._viewMonth=e,this._monthOpen=!1,this._monthSearch=""}_selectYear(e,r){r.stopPropagation(),this._viewYear=e,this._yearOpen=!1,this._yearSearch=""}_selectDay(e){this.value=Ne(e),this.internals.setFormValue(this.value),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this._close()}_selectToday(){const e=new Date;e.setHours(0,0,0,0),this._selectDay(e)}_onKeyDown(e){e.key==="Escape"&&(this._monthOpen||this._yearOpen?(this._closeNavDropdowns(),e.stopPropagation()):this._open&&(this._close(),e.stopPropagation()))}_onCalendarClick(e){if(!this._monthOpen&&!this._yearOpen)return;const r=e.composedPath();let a=!1;this.shadowRoot?.querySelectorAll(".cal-nav").forEach(l=>{r.includes(l)&&(a=!0)}),a||this._closeNavDropdowns()}_renderMonthCombo(){const e=ne.filter(r=>r.toLowerCase().includes(this._monthSearch.toLowerCase()));return s`
      ...
      </div>`}_renderYearCombo(){const e=Oe.filter(r=>String(r).includes(this._yearSearch));return s`
      ...
      </div>`}render(){const e=Fe(this.value),r=new Date;r.setHours(0,0,0,0);const a=this._calendarCells(),l=!!this.errorText;return s`
      <div class="field" @keydown=${this._onKeyDown}>
          ...
          ${this._open?s`
            <div class="calendar" role="dialog" aria-label="Date picker"
              ...
              <div class="calendar__weekdays">
                ${pt.map(n=>s`<span class="calendar__weekday">${n}</span>`)}
              </div>

              <div class="calendar__days">
                ${a.map(n=>{if(!n)return s`<span class="calendar__day is-empty"></span>`;const g=se(n,r),h=e&&se(n,e);return s`
                    <button
                      type="button"
        ...
        ${l?s`<p class="field__message field__message--error" role="alert">${this.errorText}</p>`:this.helpText?s`<p class="field__message">${this.helpText}</p>`:A}
  ...
  `}customElements.define("bcn-date-picker",ft);function vt(){const c=document.querySelector("[data-invoice-wizard]");if(!c)return;const e=c,r=e.querySelector("[data-stepper]"),a=Array.from(e.querySelectorAll("[data-stepper-step]")),l=Array.from(e.querySelectorAll(".cbf-stepper__line"));let n=0;const g=2,h=e.querySelector("[data-pdf-panel]"),m=e.querySelector("[data-pdf-frame]"),D=e.querySelector("[data-pdf-filename]"),je=e.querySelector(".cbf-invoice-workspace");function q(t,o){e.querySelectorAll(`[data-step="${t}"]`).forEach(i=>{o?i.removeAttribute("hidden"):i.setAttribute("hidden","")})}function G(t){if(!(t!==g&&!Ye(n))){if(n===0&&t===1&&et()){tt(()=>G(t));return}if(t===1&&he()==="modal"){Be();return}q(n,!1),n=t,q(n,!0),H(),n===1&&Me(),C(),window.scrollTo({top:0,behavior:"smooth"})}}function Be(){const t=e.querySelector("[data-confirm-modal]");t&&(at(),t.show())}function H(){const t=n>=a.length;r?.toggleAttribute("hidden",t),!t&&(a.forEach((o,i)=>{o.classList.toggle("is-active",i===n),o.classList.toggle("is-done",i<n)}),l.forEach((o,i)=>{o.style.background=i<n?"var(--color-primary)":"var(--color-border)"}))}let ue="page";const pe=e.querySelector("[data-confirm-mode-bar]");pe?.addEventListener("click",t=>{const o=t.target.closest("[data-confirm-mode]");if(!o)return;const i=o.dataset.confirmMode;i&&(ue=i,pe.querySelectorAll("[data-confirm-mode]").forEach(d=>{d.classList.toggle("is-active",d.dataset.confirmMode===i)}))});function he(){return ue}const Pe="";function Re(){const t=Uint8Array.from(atob(Pe),o=>o.charCodeAt(0));return new File([t],"demo-invoice.pdf",{type:"application/pdf"})}function fe(){u||R(Re());const t=(o,i)=>{const d=e.querySelector(o);d&&(d.value=i,d.dispatchEvent(new Event("input",{bubbles:!0})),d.dispatchEvent(new Event("change",{bubbles:!0})))};t('[data-field="contract"]',"CON-2025-0112"),t('[data-field="invoice-number"]',"INV-2026-0042"),t('[data-field="invoice-date"]',"2026-06-29"),t('[data-field="perf-start"]',"2026-01-01"),t('[data-field="perf-end"]',"2026-03-31"),t('[data-field="total-amount"]',"4850.00"),t('[data-field="notes"]',"Autofilled demo invoice (testing)."),G(1)}window.vendorInvoiceAutofill=fe,e.addEventListener("click",t=>{const o=t.target;o.closest("[data-wizard-next]")&&G(n+1),o.closest("[data-wizard-back]")&&n>0&&(q(n,!1),n--,q(n,!0),H(),C()),o.closest("[data-wizard-save-draft]")&&nt(),o.closest("[data-wizard-submit]")&&Le(),o.closest("[data-modal-submit]")&&Le(),o.closest("[data-modal-back]")&&e.querySelector("[data-confirm-modal]")?.close(),o.closest("[data-wizard-cancel]")&&(e.querySelector("[data-confirm-modal]")?.close(),window.location.href="/cb-fish-design/vendor-dashboard"),o.closest("[data-dev-autofill]")&&fe()}),e.querySelectorAll("[data-combobox-options]").forEach(t=>{try{t.options=JSON.parse(t.dataset.comboboxOptions??"[]")}catch{}});function C(){const t=n===1,o=n===0||t;h?.toggleAttribute("hidden",!o),je?.classList.toggle("has-pdf",o),e.querySelector("[data-upload-remove]")?.toggleAttribute("hidden",t),o&&u&&be()}function Ye(t){if(t===0){const o=Ue(),i=Ve();return o&&i}return!0}function Ue(){const t=e.querySelector('[data-step-error="upload"]'),o=!!u;return t?.toggleAttribute("hidden",o),o}function Ve(){let t=!0;[e.querySelector('[data-field="invoice-number"]'),e.querySelector('[data-field="invoice-date"]'),e.querySelector('[data-field="perf-start"]'),e.querySelector('[data-field="perf-end"]'),e.querySelector('[data-field="contract"]')].forEach(k=>{if(!k)return;(k.value??k.getAttribute("value")??"").trim()?k.removeAttribute("error-text"):(k.setAttribute("error-text","This field is required."),t=!1)});const i=e.querySelector('[data-field="perf-start"]'),d=e.querySelector('[data-field="perf-end"]'),p=i?.value??"",N=d?.value??"";p&&N&&p>N&&(d?.setAttribute("error-text","End date must be on or after start date."),t=!1);const O=e.querySelector('[data-step-error="total"]'),j=e.querySelector('[data-step-error="total-exceeds"]');return re()<=0?(t=!1,O?.removeAttribute("hidden"),j?.setAttribute("hidden",""),y?.setAttribute("error-text","Enter the invoice total amount.")):(O?.setAttribute("hidden",""),Se()?(t=!1,K()):(j?.setAttribute("hidden",""),y?.removeAttribute("error-text"))),t}let L=!1;function J(){const t=!L;e.querySelector("[data-form-lock-notice]")?.toggleAttribute("hidden",!t),e.querySelectorAll("[data-field]:not([data-readonly])").forEach(o=>{o.toggleAttribute("disabled",t)}),e.querySelector("[data-add-line-item]")?.toggleAttribute("disabled",t),e.querySelector("[data-docs-add]")?.toggleAttribute("disabled",t),e.querySelectorAll(".cbf-li-input").forEach(o=>{o.disabled=t}),e.querySelectorAll(".cbf-li-remove").forEach(o=>{o.disabled=t})}J();let u=null;const E=e.querySelector("[data-upload-zone]"),P=e.querySelector("[data-upload-input]"),I=e.querySelector("[data-mobile-upload-input]"),ve=e.querySelector("[data-upload-idle]"),ge=e.querySelector("[data-pdf-viewer]");let f=null,b=null;function me(t){e.querySelectorAll("[data-view-invoice],[data-view-doc]").forEach(o=>{o.classList.toggle("is-active",o.getAttribute("data-view-name")===t)})}function be(){b&&(URL.revokeObjectURL(b),b=null),m&&f&&(m.src=f),D&&u&&(D.textContent=u.name),me(u?.name??"")}function Ke(t){b&&(URL.revokeObjectURL(b),b=null),b=URL.createObjectURL(t),m&&(m.src=b),D&&(D.textContent=t.name),me(t.name)}function We(t){return t.type==="application/pdf"||t.type.startsWith("image/")||/\.(pdf|png|jpe?g)$/i.test(t.name)}C();const X=25*1024*1024;function Ze(t){const o=e.querySelector("[data-upload-inline-error]"),i=e.querySelector("[data-upload-inline-error-msg]");i&&(i.textContent=t),o?.removeAttribute("hidden")}function Ge(){e.querySelector("[data-upload-inline-error]")?.setAttribute("hidden","")}function He(t){return t.type==="application/pdf"||t.name.toLowerCase().endsWith(".pdf")?t.size>X?`This file is ${U(t.size)} — the maximum is 25 MB. Please upload a smaller PDF.`:null:"That file isn’t a PDF. Please upload a PDF invoice."}function R(t){const o=He(t);if(o){Ze(o);return}Ge(),u=t,ve?.setAttribute("hidden",""),ge?.removeAttribute("hidden"),e.querySelector('[data-step-error="upload"]')?.setAttribute("hidden",""),L||(L=!0,J()),f&&URL.revokeObjectURL(f),f=URL.createObjectURL(t),m&&(m.src=f),D&&(D.textContent=t.name),n===1&&Me(),C()}function _e(){u=null,P.value="",I&&(I.value=""),ge?.setAttribute("hidden",""),ve?.removeAttribute("hidden"),f&&(URL.revokeObjectURL(f),f=null),m&&(m.src=""),C()}let _=[];const Y=e.querySelector("[data-docs-input]"),Q=e.querySelector("[data-docs-list]");function ee(){Q&&(Q.innerHTML=_.map((t,o)=>`
      <div class="cbf-doc-row">
        ...
        <div class="cbf-doc-row__info">
          <span class="cbf-doc-row__name">${z(t.name)}</span>
          <span class="cbf-doc-row__size">${U(t.size)}</span>
        </div>
        <button type="button" class="cbf-doc-row__remove" data-doc-remove="${o}" aria-label="Remove ${z(t.name)}">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
        </button>
      </div>
    `).join(""))}e.querySelector("[data-docs-add]")?.addEventListener("click",()=>Y?.click());function ye(t){const o=e.querySelector("[data-docs-error]"),i=e.querySelector("[data-docs-error-msg]");t?(i&&(i.textContent=t),o?.removeAttribute("hidden")):o?.setAttribute("hidden","")}function xe(t){if(!t.length)return;const o=t.filter(d=>d.size>X),i=new Set(_.map(d=>d.name));if(_.push(...t.filter(d=>d.size<=X&&!i.has(d.name))),o.length){const d=o.map(p=>p.name).join(", ");ye(`${d} ${o.length>1?"each exceed":"exceeds"} the 25 MB limit and ${o.length>1?"were":"was"} not added.`)}else ye("");ee()}Y?.addEventListener("change",()=>{xe(Array.from(Y.files??[])),Y.value=""});const $=e.querySelector("[data-docs-zone]");$?.addEventListener("dragover",t=>{t.preventDefault(),$.classList.add("is-over")}),$?.addEventListener("dragleave",t=>{$.contains(t.relatedTarget)||$.classList.remove("is-over")}),$?.addEventListener("drop",t=>{t.preventDefault(),$.classList.remove("is-over"),xe(Array.from(t.dataTransfer?.files??[]))}),Q?.addEventListener("click",t=>{const o=t.target.closest("[data-doc-remove]");o&&(_.splice(Number(o.dataset.docRemove),1),ee())}),e.querySelector("[data-review-content]")?.addEventListener("click",t=>{const o=t.target;if(o.closest("[data-view-invoice]")){be();return}const i=o.closest("[data-view-doc]");if(i){const d=_[Number(i.dataset.viewDoc)];d&&Ke(d)}}),e.querySelector("[data-upload-browse]")?.addEventListener("click",()=>P.click()),e.querySelector("[data-upload-remove]")?.addEventListener("click",_e),e.querySelector("[data-mobile-upload-btn]")?.addEventListener("click",()=>I?.click()),P.addEventListener("change",()=>{const t=P.files?.[0];t&&R(t)}),I?.addEventListener("change",()=>{const t=I.files?.[0];t&&R(t)}),E.addEventListener("dragover",t=>{t.preventDefault(),E.classList.add("is-over")}),E.addEventListener("dragleave",()=>E.classList.remove("is-over")),E.addEventListener("drop",t=>{t.preventDefault(),E.classList.remove("is-over");const o=t.dataTransfer?.files?.[0];o&&R(o)});function U(t){return t<1024*1024?`${(t/1024).toFixed(0)} KB`:`${(t/(1024*1024)).toFixed(1)} MB`}function te(t){if(!t)return"—";const o=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t),i=o?new Date(Number(o[1]),Number(o[2])-1,Number(o[3])):new Date(t);return Number.isNaN(i.getTime())?t:i.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}let v=[];const V=e.querySelector("[data-line-items]"),we=e.querySelector("[data-invoice-total]"),y=e.querySelector('[data-field="total-amount"]');function re(){const t=String(y?.value??"").replace(/[^0-9.]/g,""),o=parseFloat(t);return Number.isFinite(o)&&o>0?o:0}function ke(){const t=oe[w?.value??""];return t?t.remaining:null}function Se(){const t=ke();return t!=null&&re()>t}function K(){const t=e.querySelector('[data-step-error="total-exceeds"]'),o=ke();if(o!=null&&Se()){const i=t?.querySelector("[data-remaining-amount]");i&&(i.textContent=T(o)),t?.removeAttribute("hidden"),y?.setAttribute("error-text","Exceeds the remaining contract balance.")}else t?.setAttribute("hidden",""),y?.getAttribute("error-text")==="Exceeds the remaining contract balance."&&y.removeAttribute("error-text")}function $e(){v.push({description:"",qty:1,unitPrice:0}),Ae()}function Je(t){v.splice(t,1),Ae()}function Ae(){const t=L?"":" disabled";V.innerHTML=v.map((o,i)=>`
      <div class="cbf-line-item" data-row="${i}">
        <input${t}
          class="cbf-li-input cbf-li-desc"
          type="text"
          placeholder="Description…"
          value="${z(o.description)}"
        ...
        <input${t}
          ...
          style="text-align:right"
        />
        <span class="cbf-li-total" data-li-total="${i}">${T(o.qty*o.unitPrice)}</span>
        <button type="button"${t} class="cbf-li-remove" data-li-remove="${i}" aria-label="Remove line item">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
        </button>
      </div>
    `).join(""),De()}function De(){const t=v.reduce((o,i)=>o+i.qty*i.unitPrice,0);we&&(we.textContent=T(t))}function T(t){return t.toLocaleString("en-US",{style:"currency",currency:"USD"})}function z(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}V.addEventListener("input",t=>{const o=t.target,i=Number(o.dataset.liIdx),d=o.dataset.liField;if(!d||isNaN(i))return;d==="description"&&(v[i].description=o.value),d==="qty"&&(v[i].qty=Math.max(1,Number(o.value)||1)),d==="unitPrice"&&(v[i].unitPrice=Math.max(0,Number(o.value)||0));const p=V.querySelector(`[data-li-total="${i}"]`);p&&(p.textContent=T(v[i].qty*v[i].unitPrice)),De()}),V.addEventListener("click",t=>{const o=t.target.closest("[data-li-remove]");o&&Je(Number(o.dataset.liRemove))}),e.querySelector("[data-add-line-item]")?.addEventListener("click",$e);const x=e.querySelector("[data-final-invoice]"),Xe=e.querySelector("[data-final-invoice-callout]"),F=e.querySelector("[data-final-invoice-dialog]"),w=e.querySelector('[data-field="contract"]');let oe={};try{oe=JSON.parse(w?.dataset.contractAmounts??"{}")}catch{}y?.addEventListener("input",K),y?.addEventListener("change",K),w?.addEventListener("change",K);const qe=e.querySelector('[data-field="project"]');let Ce={};try{Ce=JSON.parse(w?.dataset.contractProjects??"{}")}catch{}w?.addEventListener("change",()=>{qe&&(qe.value=Ce[w.value??""]??"")});function ie(){Xe?.classList.toggle("is-flagged",!!x?.checked)}let W=!1;x?.addEventListener("change",()=>{W=!0,ie()});function Ee(){return re()}function Qe(){const t=oe[w?.value??""],o=Ee();if(!t||o<=0)return!1;const i=t.remaining-o;return i>=0&&i<.05*t.total}function et(){return!!x&&!W&&!x.checked&&Qe()}function tt(t){if(!F){t();return}const o=w?.value||"this contract";F.message=`The remaining balance on ${o} is within 5% of this invoice's total, which usually means it's the last one. Marking it final closes out the contract — should we flag this as the final invoice?`;const i=d=>{F.removeEventListener("resolved",i),!d.detail?.dismissed&&(W=!0,d.detail?.confirmed&&(x.checked=!0,ie()),t())};F.addEventListener("resolved",i),F.show()}$e();function M(t){return e.querySelector(t)?.value??""}function rt(t){const o=e.querySelector(t);if(!o)return"";const i=o.value??"";return o.options?.find(p=>p.value===i)?.label??i}const ot='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',it='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/></svg>';function ze(t,o=!1){if(!t)return;const i=(S,ae)=>{const Ie=t.querySelector(`[data-review="${S}"]`);Ie&&(Ie.textContent=ae)};i("file-name",u?.name??"(no file)"),i("file-size",u?U(u.size):"");const d=t.querySelector("[data-view-invoice]");d&&(d.toggleAttribute("hidden",!o||!u),d.setAttribute("data-view-name",u?.name??"")),i("invoice-number",M('[data-field="invoice-number"]')||"No invoice number"),i("contract",rt('[data-field="contract"]')||"—"),i("project",M('[data-field="project"]')||"—");const p=M('[data-field="invoice-date"]');i("issued",p?te(p):"Not set");const N=M('[data-field="perf-start"]'),O=M('[data-field="perf-end"]');i("perf-start",N?te(N):"Not set"),i("perf-end",O?te(O):"Not set"),i("total",T(Ee())),t.querySelector('[data-review="final-flag"]')?.toggleAttribute("hidden",!x?.checked);const j=t.querySelector('[data-review="docs-list"]');j&&(j.innerHTML=_.map((S,ae)=>`
        <div class="cbf-review-row">
          ${ot}
          <span>${z(S.name)}</span>
          <span class="cbf-review-meta">${U(S.size)}</span>
          ${o&&We(S)?`<button type="button" class="cbf-doc-view" data-view-doc="${ae}" data-view-name="${z(S.name)}" aria-label="Preview ${z(S.name)}">${it}</button>`:""}
        </div>`).join("")),t.querySelector('[data-review="docs-card"]')?.toggleAttribute("hidden",_.length===0);const k=M('[data-field="notes"]');i("notes",k),t.querySelector('[data-review="notes-card"]')?.toggleAttribute("hidden",!k)}function Me(){ze(e.querySelector("[data-review-content]"),!0)}function at(){ze(e.querySelector("[data-modal-review-content]"))}function nt(){document.querySelector("[data-snackbar]")?.success?.("Draft saved.",{duration:3e3}),setTimeout(()=>{window.location.href="/cb-fish-design/vendor-dashboard"},700)}function Le(){const t=he()==="modal",o=t?"[data-modal-submit]":"[data-wizard-submit]",i=e.querySelector(`${o} button.esa-button`);if(i){if(i.classList.add("esa-button--loading"),i.disabled=!0,i.setAttribute("aria-busy","true"),!i.querySelector(".esa-button__spinner")){const d=document.createElement("span");d.className="esa-button__spinner",d.setAttribute("aria-hidden","true"),i.prepend(d)}i.querySelector(".esa-button__label")?.classList.add("esa-button__label--hidden")}setTimeout(()=>{const d=`INV-${new Date().getFullYear()}-${String(Math.floor(Math.random()*9e4)+1e4)}`;st(i),t&&e.querySelector("[data-confirm-modal]")?.close(),lt(),document.querySelector("[data-snackbar]")?.success?.(`Invoice ${d} submitted.`,{duration:4e3})},1500)}function st(t){t&&(t.classList.remove("esa-button--loading"),t.disabled=!1,t.removeAttribute("aria-busy"),t.querySelector(".esa-button__spinner")?.remove(),t.querySelector(".esa-button__label")?.classList.remove("esa-button__label--hidden"))}function lt(){_e(),_=[],ee(),e.querySelectorAll("[data-field]").forEach(t=>{typeof t.checked=="boolean"&&(t.checked=!1),t.value="",t.removeAttribute?.("error-text")}),e.querySelectorAll("[data-step-error]").forEach(t=>t.setAttribute("hidden","")),W=!1,x&&(x.checked=!1),ie(),L=!1,J(),q(n,!1),n=0,q(0,!0),H(),C(),window.scrollTo({top:0,behavior:"smooth"})}}vt();
