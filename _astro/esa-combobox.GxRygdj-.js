import{b as r,i as h,A as o,t as p,a as u}from"./typography.C7xuE2z_.js";import{a as f}from"./a11y.c6v_nqwk.js";import{a as g}from"./announcer.dkeh-00N.js";const b=r`<svg
  class="error__icon"
  viewBox="0 0 24 24"
  fill="none"
  stroke="currentColor"
...
>
  ...
  />
    ...
    `}renderChips(){return this.selectedOptions.length===0?o:r`<div class="chips">
      ...
      stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12a9 9 0 1 1-6.219-8.56" /></svg>`}static{this.styles=[p,f,u`
    :host {
      display: block;
