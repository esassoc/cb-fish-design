import{i as c,b as o,a as d}from"./lit-element.C8p3bJxG.js";import{i as r,u as f}from"./static.CxNnSrf9.js";const l={2:r`h2`,3:r`h3`,4:r`h4`,5:r`h5`,6:r`h6`};class u extends c{constructor(){super(),this.previousFocus=null,this.confirm=()=>this.resolve(!0),this.cancel=()=>this.resolve(!1),this.dismiss=()=>this.resolve(!1,!0),this.onKeydown=e=>{if(this.open){if(e.key==="Escape")e.preventDefault(),this.dismiss();else if(e.key==="Tab"){const i=this.renderRoot,t=Array.from(i.querySelectorAll("button:not([disabled])"));if(t.length===0)return;const a=t[0],n=t[t.length-1],s=i.activeElement;e.shiftKey&&s===a?(e.preventDefault(),n.focus()):!e.shiftKey&&s===n&&(e.preventDefault(),a.focus())}}},this.open=!1,this.heading="",this.headingLevel=2,this.message="",this.variant="default",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.showIcon=!0,this.showCloseButton=!0}static{this.properties={open:{type:Boolean,reflect:!0},heading:{type:String},headingLevel:{type:Number,attribute:"heading-level"},message:{type:String},variant:{type:String,reflect:!0},confirmLabel:{type:String,attribute:"confirm-label"},cancelLabel:{type:String,attribute:"cancel-label"},showIcon:{type:Boolean,attribute:"show-icon"},showCloseButton:{type:Boolean,attribute:"show-close-button"}}}renderTitle(){const e=l[this.headingLevel]??l[2];return f`<${e} class="esa-confirm-dialog__title">${this.heading}</${e}>`}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeydown)}updated(e){e.has("open")&&(this.open?(this.previousFocus=document.activeElement,requestAnimationFrame(()=>{this.renderRoot.querySelector(".esa-confirm-dialog__confirm")?.focus()})):this.previousFocus&&(this.previousFocus.focus?.(),this.previousFocus=null))}show(){this.open=!0}resolve(e,i=!1){this.open=!1,i&&this.dispatchEvent(new CustomEvent("dismiss",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(e?"confirm":"cancel",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("resolved",{detail:{confirmed:e,dismissed:i},bubbles:!0,composed:!0}))}icon(){return this.showIcon?this.variant==="danger"?o`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>`:this.variant==="warning"?o`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`:o`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`:null}render(){return this.open?o`
  ...
  `}}customElements.get("esa-confirm-dialog")||customElements.define("esa-confirm-dialog",u);
