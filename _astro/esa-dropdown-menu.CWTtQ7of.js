import{i as s,b as r,t as d,a as l}from"./typography.C7xuE2z_.js";import{r as c,F as a,d as u}from"./overlay.BBIxLHx2.js";class p extends s{constructor(){super(),this.toggle=()=>{this.open?this.close():this.openMenu()},this.onDocumentClick=e=>{!this.contains(e.target)&&e.target!==this&&this.close()},this.onKeydown=e=>{if(!this.open){(e.key==="ArrowDown"||e.key==="ArrowUp")&&(e.preventDefault(),this.openMenu());return}switch(e.key){case"Escape":e.preventDefault(),this.close();break;case"ArrowDown":e.preventDefault(),this.focusItem(this.focusedIndex+1);break;case"ArrowUp":e.preventDefault(),this.focusItem(this.focusedIndex-1);break;case"Home":e.preventDefault(),this.focusItem(0);break;case"End":e.preventDefault(),this.focusItem(this.menuItems.length-1);break;case"Tab":this.close();break}},this.items=[],this.position="below-start",this.width="auto",this.open=!1}static{this.properties={items:{type:Array},position:{type:String,reflect:!0},width:{type:String,reflect:!0},open:{type:Boolean,reflect:!0}}}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this.onDocumentClick,!0)}updated(e){this.syncTrigger(),e.has("open")&&(this.open?(document.addEventListener("click",this.onDocumentClick,!0),this.updateComplete.then(()=>this.focusItem(0))):document.removeEventListener("click",this.onDocumentClick,!0))}openMenu(){this.open=!0}close(){this.open&&(this.open=!1,c(this.triggerEl))}get triggerEl(){const t=(this.renderRoot.querySelector("slot")?.assignedElements({flatten:!0})??[]).find(n=>n instanceof HTMLElement);return t?t.matches(a)?t:t.querySelector(a)??t:null}syncTrigger(){const e=this.triggerEl;e&&(e.setAttribute("aria-haspopup","menu"),e.setAttribute("aria-expanded",String(this.open)),e.setAttribute("aria-controls","menu"),e.matches(a)||(e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.hasAttribute("role")||e.setAttribute("role","button")))}get menuItems(){return Array.from(this.renderRoot.querySelectorAll(".esa-dropdown-menu__item:not([disabled])"))}focusItem(e){const o=this.menuItems;if(!o.length)return;const t=(e+o.length)%o.length;o.forEach((n,i)=>n.setAttribute("tabindex",i===t?"0":"-1")),o[t].focus()}get focusedIndex(){return this.menuItems.indexOf(u())}selectItem(e){e.disabled||(e.action&&this.dispatchEvent(new CustomEvent("menu-action",{detail:e.action,bubbles:!0,composed:!0})),this.close())}render(){return r`
